...
public class ExtJButton extends JButton {
    ...
    public static final Color BUTTON_COLOR1 = new Color(12, 12, 12);
    public static final Color BUTTON_COLOR2 = new Color(12, 12, 12);
    public static final Color BUTTON_FOREGROUND_COLOR1 = new Color(255, 215, 0);
    public static final Color BUTTON_FOREGROUND_COLOR2 = new Color(255, 215, 0);
	...
	protected void paintComponent(Graphics g) {
		...
		if (getModel().isPressed()) {
			p1 = new GradientPaint(0, 0, new Color(59, 89, 152), 0, h - 1,
					new Color(100, 100, 100));
			p2 = new GradientPaint(0, 1, new Color(59, 89, 152, 50), 0, h - 3,
					new Color(255, 255, 255, 100));
		} else {
			p1 = new GradientPaint(0, 0, new Color(100, 100, 100), 0, h - 1,
					new Color(59, 89, 152));
			p2 = new GradientPaint(0, 1, new Color(255, 255, 255, 100), 0,
					h - 3, new Color(59, 89, 152, 50));
		}
